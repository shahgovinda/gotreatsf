...
import { OrderDetails, Address, OrderItem } from '../types/orderTypes'; // Import OrderItem
...
const Checkout = () => {
  ...
  const handlePaymentClick = async () => {
    ...
    try {
      ...
      // Create a valid OrderDetails object
      const orderDetails: OrderDetails = {
        items: items as OrderItem[], // Cast to OrderItem[] to match the new type
        grossTotalPrice: grossTotalPrice, // Changed to a number
        ...
        deliveryDate: preferredDeliveryDate.toISOString(), // Correctly assign deliveryDate
        customer: {
          uid: userDetails.uid,
        ...
        voucherDiscount: appliedVoucher || undefined, // Assign the appliedVoucher object
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
      ...
      <OrderPlacedModal isOpen={isOrderPlacedModalOpen} onOpenChange={onOpenOrderPlacedModalChange} />
    </div>
  );
};
