...
const Orders = () => {
    ...
    useEffect(() => {
        ...
        orders.forEach(order => {
            ...
            currentStatuses[order.id] = currentStatus;
        ...
        if (statusChanged) {
            audioRef.current.play().catch(e => console.log("Audio playback blocked by browser policy:", e));
            toast('🔔 Your order status has been updated!', { duration: 4000 });
        }
                        ...
                        <div className='flex flex-col h-full justify-between '>
                            <div>
                                ...
                                <DrawerBody className="h-full overflow-auto mt-20">
                                    ...
                                    {/* ✅ FIX: 1. ITEMS AND QUANTITIES (MOVED TO TOP) */}
                                    ...
                                    {/* ✅ FIX: 2. BILLING SUMMARY (MOVED AFTER ITEMS) */}
