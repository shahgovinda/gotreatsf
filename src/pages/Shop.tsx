...
                        // UPDATED: Changed the background and hover colors
                        // UPDATED: Changed md:w-1/6 to md:max-w-md and added mx-auto to center it
                        className="fixed w-full md:max-w-md mx-auto bottom-0 left-1/2 -translate-x-1/2 bg-green-600 cursor-pointer text-white px-4 shadow-2xl hover:bg-orange-600 transition-all duration-300 z-50 rounded-t-xl md:rounded-t-lg"
                    >
                        {/* The button handles the click action and holds the content */}
                        <button 
                            type='button' 
                            // UPDATED: Added justify-between to ensure proper spacing on all devices
                            className="flex items-center justify-between gap-4 w-full py-4"
...
                                        // UPDATED: Border color to match green
                                        className="w-7 h-7 object-cover rounded-full border-2 border-green-600"
                                        style={{ 
...
                                    />
                                ))}
                                {/* UPDATED: The text is now correctly offset from the images on all screen sizes */}
                                <p className={`font-medium text-sm ${cartImages.length > 0 ? 'ml-4' : 'ml-0'} whitespace-nowrap`}>
