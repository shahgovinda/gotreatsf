...
const Contact = () => {
    ...
    useEffect(() => {
        const checkFormValidity = () => {
            ...
            // The form is only valid if all fields meet their criteria and there are no validation errors.
                ...
                <form className='mt-4 sm:mt-10 w-full max-w-lg space-y-4 sm:space-y-6' onSubmit={onSubmit}>
                    ...
                    <div className="relative">
                        ...
                        <div className="relative">
                            <input
                                ...
                                maxLength={10} // HTML5 validation to prevent more than 10 chars
                                className={`pl-12 border border-[#ff7a1a]/30 bg-white text-[#2d1a0a] rounded-xl p-3 w-full
                                focus:outline-none focus:border-[#ff7a1a] focus:ring-2 focus:ring-[#ff7a1a]/30 transition-all duration-300
                                placeholder:text-gray-400 ${phoneError ? 'border-red-500' : ''}`}
                    ...
                    <div className="relative">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className={`pl-12 border border-[#ff7a1a]/30 bg-white text-[#2d1a0a] rounded-xl p-3 w-full
                                focus:outline-none focus:border-[#ff7a1a] focus:ring-2 focus:ring-[#ff7a1a]/30 transition-all duration-300
                                placeholder:text-gray-400 ${emailError ? 'border-red-500' : ''}`}
                    ...
                    <div className="w-full mt-8">
                        <button
                            ...
                            ${(submitting || !isFormValid) ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}`}
                        >
